...
CREATE TABLE `ba_log` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=75 DEFAULT CHARSET=utf8 COMMENT='管理员日志表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `users` VALUES (1,'jiuge','$2y$10$QQOqZ7d1g3KFNG3hc0JvjOkboWf5FloVlQYcTer0aJA43w9Rycple','123456','192.168.2.100','jiuge@qq.com','946493655',63929131,4294967295,20,'滨江区 浦沿街道 联庄一区 29号 几楼','http://www.jiugewenhua.com/uploads/images/2017-03-23/58d378ab35291.png','','946493655@qq.com',3,1,50,0,1494986949,0,1494986949);
/*!40000 ALTER TABLE `users` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `users_bak20170517`
--

DROP TABLE IF EXISTS `users_bak20170517`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `users_bak20170517` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `username` varchar(255) NOT NULL COMMENT '用户名称',
  `password` varchar(255) NOT NULL COMMENT '登陆密码，hash加密',
  `pwd` varchar(20) NOT NULL COMMENT '原密码',
...
--
-- Dumping data for table `users_bak20170517`
--

LOCK TABLES `users_bak20170517` WRITE;
/*!40000 ALTER TABLE `users_bak20170517` DISABLE KEYS */;
INSERT INTO `users_bak20170517` VALUES (1,'jiuge','$2y$10$U93WQ6hOko5F.Jz0S9/F9.G44DfNjEkRx2CJXulXabRI/ICArE94S','123456','','jiuge@qq.com','946493655',63929131,4294967295,20,'滨江区 浦沿街道 联庄一区 29号 几楼','http://www.jiugewenhua.com/uploads/images/2017-03-23/58d378ab35291.png','','946493655@qq.com',3,1,50,0,1470795559,1481702547,1492394632),(2,'jiuge2','$2y$10$X5BdoH0p0n.E3hxCVag/neinTfiHXbMrCHUEEqf8ZpUQGaeOxUUBe','123456','','946493655@qq.com','',0,0,30,'','','','',3,0,50,0,1470795559,0,1489974282),(24,'jiuge3','$2y$10$1PuTTDN/g1XH9BYB2jD3mOh4pPnLwoAomgqf1nz/7suZwAmM4Z6ia','123456','192.168.2.100','','',0,0,0,'','','','',1,0,1,0,1480742412,0,1480742412);
/*!40000 ALTER TABLE `users_bak20170517` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2017-05-17 10:48:14
